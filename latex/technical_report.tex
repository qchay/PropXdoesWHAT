...
\begin{itemize}
	...
	\item\textbf{As a user, I want to see the implications of a law.} \\ We solved this issue by having a description for each law. This was done by querying the description parameter data from our law API and displaying it onto the appropriate model page. 
	\\
...
\noindent The following are the user stories gathered for Phase 2: \\
...
\textbf{TODO: Describe database in AWS, and two servers for front and back end}
...
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{Group8_UML(1).png}
\end{figure}
